---
name: "prdskills"
description: "Generate comprehensive Product Requirements Documents (PRD) based on the virtual warehouse module template. Supports structured documentation with executive summaries, user flows, functional modules, and detailed logic for all types of requirements."
---

# PRD生成技能

This skill generates comprehensive Product Requirements Documents (PRD) based on the virtual warehouse module template. It creates structured documentation packages that include executive summaries, user flows, functional modules, and detailed logic specifications, ensuring consistency across system components.

## When to Use

Invoke this skill when:
- User needs to create detailed PRD documentation for new system modules
- User wants to generate structured requirements documents based on existing templates
- User needs to maintain consistency across multiple PRD documents
- User wants to accelerate the documentation process for new features
- User needs to ensure proper documentation structure for system components

## PRD Template Structure

### Virtual Warehouse Module PRD Structure
