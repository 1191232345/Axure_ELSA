...
<body>
    <div class="container">
        ...
        <div class="progress" id="progress">
            ...
            <p style="text-align: center; color: #666; font-size: 1em;">正在处理Excel文件，请稍候...</p>
        </div>
                ...
                if (result.status === 'success') {
                    ...
                    html += `
                        <div class="result-card">
                            <div class="result-title">
                                <i class="fas fa-check-circle"></i> ${result.filename}
                            </div>
                            ${result.tracking_number ? `
                            <div class="result-item">
                                <i class="fas fa-barcode"></i> Tracking Number: ${result.tracking_number}
                            </div>
                            ` : ''}
                            <div class="result-item">
                                <i class="fas fa-image"></i> 提取图片数量: ${result.image_count}
                            </div>
                            <div class="result-item">
                                <i class="fas fa-file-pdf"></i> 生成PDF: ${result.pdf_filename}
                            </div>
                        </div>
                    `;
                    ...
                    html += `
                        <div class="result-card error">
                            <div class="result-title">
                                <i class="fas fa-times-circle"></i> ${result.filename}
                            </div>
                            <div class="result-item">${result.message}</div>
                        </div>
                    `;
            ...
            if (successCount > 0) {
                html += `
                    <div class="download-section">
                        <a href="/download/${sessionId}" class="btn btn-success">
                            <i class="fas fa-download"></i> 下载所有PDF文件
                        </a>
                    </div>
                `;
            }
...
if __name__ == '__main__':
    ...
    print("💡 使用说明:")
    print("   1. 在浏览器中打开上述地址")
    print("   2. 拖拽或选择一个或多个Excel文件")
    print("   3. 点击'开始处理'按钮")
    print("   4. 系统会自动提取Invoice、Customer Message、Damage Photo和SupportingDocuments四个Sheet页的图片并生成PDF")
    print("   5. 自动压缩图片，确保PDF文件不超过4MB")
    print("="*60 + "\n")
